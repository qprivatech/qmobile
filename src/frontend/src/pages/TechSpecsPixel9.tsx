...
/**
 * Technical specifications page for Google Pixel 9.
...
const PHONE_NAME_KEY = "products.pixel9";
const HREFLANG_PATH = "/googlepixel9/teknik-ozellikleri";
...
const sections: SpecSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { fieldKey: "techSpecs.fields.pixelDensity", value: "422 ppi" },
      {
      ...
      },
      {
        ...
        value: "techSpecs.values.displayDetailsPixel9",
      },
      {
...
export default function TechSpecsPixel9() {
  const { t } = useI18n();
      ...
      <Section variant="card">
        <div className="mb-8">
          <Link
            ...
            data-ocid="techspecs_pixel9.back_link"
          >
        ...
        <div className="space-y-8">
          {sections.map((section, sIdx) => (
            <Card
              ...
              data-ocid={`techspecs_pixel9.section.${sIdx + 1}`}
            >
                  ...
                  <tbody>
                    {section.rows.map((row, rIdx) => (
                      <tr
                        ...
                        data-ocid={`techspecs_pixel9.row.${sIdx + 1}.${rIdx + 1}`}
                      >
                        <th
                          scope="row"
