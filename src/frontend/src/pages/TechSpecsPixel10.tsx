...
/**
 * Technical specifications page for Google Pixel 10.
...
const PHONE_NAME_KEY = "products.pixel10";
const HREFLANG_PATH = "/googlepixel10/teknik-ozellikleri";
...
const sections: SpecSection[] = [
  {
    ...
    rows: [
      ...
      { fieldKey: "techSpecs.fields.processor", value: "Google Tensor G4" },
      { fieldKey: "techSpecs.fields.clockSpeed", value: "3.1 GHz" },
      ...
      { fieldKey: "techSpecs.fields.sarHead", value: "0.99 W/kg" },
      { fieldKey: "techSpecs.fields.sarBody", value: "1.39 W/kg" },
      ...
      { fieldKey: "techSpecs.fields.gtin", value: "0840353950030" },
  ...
  },
  {
    ...
    rows: [
      ...
      { fieldKey: "techSpecs.fields.screenDiagonalInch", value: '6.3"' },
      { fieldKey: "techSpecs.fields.screenDiagonalCm", value: "16 cm" },
      { fieldKey: "techSpecs.fields.resolution", value: "1080 x 2424" },
      { fieldKey: "techSpecs.fields.resolutionWidth", value: "1080" },
      { fieldKey: "techSpecs.fields.resolutionHeight", value: "2424" },
      { fieldKey: "techSpecs.fields.aspectRatio", value: "20:9" },
      { fieldKey: "techSpecs.fields.pixelDensity", value: "422.2 ppi" },
      {
      ...
      },
      {
        ...
        value: "techSpecs.values.displayDetailsPixel10",
      },
      {
        fieldKey: "techSpecs.fields.antiScratch",
        value: "Corning Gorilla Glass 7i",
      },
      {
...
export default function TechSpecsPixel10() {
  const { t } = useI18n();
      ...
      <Section variant="card">
        <div className="mb-8">
          <Link
            ...
            data-ocid="techspecs_pixel10.back_link"
          >
        ...
        <div className="space-y-8">
          {sections.map((section, sIdx) => (
            <Card
              ...
              data-ocid={`techspecs_pixel10.section.${sIdx + 1}`}
            >
                  ...
                  <tbody>
                    {section.rows.map((row, rIdx) => (
                      <tr
                        ...
                        data-ocid={`techspecs_pixel10.row.${sIdx + 1}.${rIdx + 1}`}
                      >
                        <th
                          scope="row"
